...
const User =(props) => {
    ...
    return(
        <>
            ...
            <UserForm user={props.user} close={close} operation={"Update"} open={open}/>
        </>
    )
}
